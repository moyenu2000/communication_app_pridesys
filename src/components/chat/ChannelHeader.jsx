...
const ChannelHeader = () => {
  const { selectedChat, setSelectedChat, currentChannelViewers, pinnedMessages } = useChatState();
  const { starredChannels, setStarredChannels, subscribedChannels, setSubscribedChannels } = useInformation();
  const channelName = selectedChat ? selectedChat.name : 'Select a channel';
